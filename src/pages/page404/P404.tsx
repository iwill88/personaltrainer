...
const P404 = () => {
    ...
    return (
        <div className='container mx-auto my-10'>
            <div className="col-md-6 align-self-center m-5">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <g>
                        <defs>
                            <clipPath id="GlassClip" style={glassStyles}>
                                <path
                ...
                c6.755-0.61,20.546-0.608,41.785,5.087s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
                        ...
                        <g id="planet" style={planetStyles} >
      ...
      M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149" />
                        ...
                        <g id="spaceman" clipPath="url(cordClip)" style={astronautStyles}>
      ...
      C360.647,451.083,349.251,457.661,338.164,454.689z" />
        ...
        s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
          ...
          278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928         " />
                ...
                <h2>OH No! Tu estas perdido.</h2>
                <p>la pagina que tu intentas visitar se perdio en el espacio.
                    La forma en la que llegaste aqui es un misterio.
                    pero con hacer click en el boton de abajo puedes volver a casa.
                </p>
                <Link to="/">
